...
/*   Updated: 2015/09/08 14:35:48 by jbalestr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ElevatorStream::setupSprite(void)
{
	...
	m_spriteBottomBack.setSpriteSheet(resources.getSpriteSheet(ELEVATOR_BOTTOM_BACK_OSS));
	m_spriteBottomBack.setAnimation(m_animation);
	m_spriteBottomBack.setScale(sf::Vector2f(0.8f, 0.8f));
	m_spriteBottomBack.play();
	m_spriteTopFront.setSpriteSheet(resources.getSpriteSheet(ELEVATOR_TOP_FRONT_OSS));
	m_spriteTopFront.setAnimation(m_animation);
	m_spriteTopFront.setScale(sf::Vector2f(0.8f, 0.8f));
	m_spriteTopFront.play();
	m_spriteTopBack.setSpriteSheet(resources.getSpriteSheet(ELEVATOR_TOP_BACK_OSS));
