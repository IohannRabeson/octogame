...
ChallengePixelate::ChallengePixelate(void) :
	AChallenge(PIXELATE_FRAG, 6.f, 4.f, sf::FloatRect(sf::Vector2f(50.f * 16.f, -210.f * 16.f), sf::Vector2f(120.f * 16.f, 155.f * 16.f)), ABiome::Type::Ice, std::pair<float, float>(0.033f, 0.16f), std::pair<float, float>(0.25f, 0.75f))
{}
