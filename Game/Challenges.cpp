...
ChallengePersistence::ChallengePersistence(void) :
	AChallenge(PERSISTENCE_FRAG, 6.f, 1.5f, sf::FloatRect(sf::Vector2f(90.f * 16.f, -150.f * 16.f), sf::Vector2f(250.f * 16.f, 750.f * 16.f)), ABiome::Type::Desert, std::pair<float, float>(0.7f, 0.9f), std::pair<float, float>(1.f, 2.f))
{
