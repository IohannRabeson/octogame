	...
	m_eventTimerMax(sf::seconds(2.f))
{
	...
	m_musicLevel[21] = AreaMusic(Level::EndRocket, MUSIC_SPACE_SHIP_OGG, sf::FloatRect());
	m_musicLevel[22] = AreaMusic(Level::EndTimeLapse, MUSIC_SPACE_SHIP_OGG, sf::FloatRect());
