...
void CameraManager::init(MapManager * mapManager)
{
	...
	m_halfWidth = octo::Application::getGraphicsManager().getVideoMode().width / 2.f;
	m_halfHeight = octo::Application::getGraphicsManager().getVideoMode().height / 2.f;
}
...
void CameraManager::update(float pf_deltatime)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left))
		m_camera.move(2600.f * pf_deltatime, 0.f);
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right))
		m_camera.move(-2600.f * pf_deltatime, 0.f);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up))
		m_camera.move(0.f, 2600.f * pf_deltatime);
