...
/*
	layer = new GenerativeLayer(getRockColor(), sf::Vector2f(0.2f, 0.6f), mapSize, 8.f, 10, 0.1f, 1.f, 10.f);
	...
	vector.push_back(layer);
*/
	GenerativeLayer * layer = new GenerativeLayer(m_tileStartColor, sf::Vector2f(0.5f, 0.3f), mapSize, 12.f, 0, 0.1f, 0.3f, 6.f);
	layer->setBackgroundSurfaceGenerator([](Noise & noise, float x, float y)
		{
...
Map::MapSurfaceGenerator JungleBBiome::getMapSurfaceGenerator()
{
	return [this](Noise & noise, float x, float y)
	{
		...
		//float m = n / 3.f;
		m_pointX = {0.f     , 35.f , 44.f , 45.f, 55.f, 56.f , 60.f , 90.f          , 200.f    , 320.f, 359.f, 381.f, 382.f, 389.f, 415.f, 417.f , 465.f, 550.f};
		m_pointY = {n - 1.2f, -1.4f, -1.2f, 5.f , 5.f , -0.1f, -0.6f, n / 2.f - 0.7f, n - 0.7f, -0.1f, -0.1f, 0.f  , 5.f  , 3.38f, 3.38f, -1.05f, -1.1f, n - 1.1f};
