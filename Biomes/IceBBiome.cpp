...
IceBBiome::IceBBiome() :
	...
	m_mapSeed(42u),
	m_octoStartPosition(330.f * 16.f, 2200.f),
	...
	m_rainbowIntervalTime(sf::seconds(1.f), sf::seconds(2.f))
{
	...
	m_instances[460] = MAP_ICE_B_PORTAL_OMP;
	m_gameObjects[326] = GameObjectType::PortalSnow;
...
std::vector<ParallaxScrolling::ALayer *> IceBBiome::getLayers()
{
	...
	GenerativeLayer * layer = new GenerativeLayer(randomColor(sf::Color(0, 5, 10)), sf::Vector2f(0.2f, 0.6f), mapSize, 8.f, -35, 0.1f, 1.f, 10.f);
	layer->setBackgroundSurfaceGenerator([](Noise & noise, float x, float y)
		{
			return noise.perlin(x * 2.f, y, 2, 2.f);
		});
	vector.push_back(layer);
	layer = new GenerativeLayer(randomColor(sf::Color(0, 5, 10)), sf::Vector2f(0.4f, 0.4f), mapSize, 10.f, -30, 0.1f, 0.9f, 6.f);
	layer->setBackgroundSurfaceGenerator([](Noise & noise, float x, float y)
		{
...
Map::MapSurfaceGenerator IceBBiome::getMapSurfaceGenerator()
{
	return [this](Noise & noise, float x, float y)
	{
		...
		m_pointX = {25.f, 50.f, 51.f, 317.f, 325.f, 335.f, 380.f    , 420.f    , 459.f, 460.f, 499.f, 500.f, 550.f};
		m_pointY = {m   , 0.f , 0.2f, 0.13f, 0.17f, 0.17f, m + 0.04f, m + 0.04f, 0.13f, 0.4f , 0.4f , 0.15f, n};
...
sf::Color	IceBBiome::getDayLightColor()
{
