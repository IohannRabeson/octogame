...
IceCBiome::IceCBiome() :
	...
	m_tileEndColor(47, 99, 121),
	m_waterLevel(-1.f),
	m_waterColor(255, 255, 255, 200),
	m_destinationIndex(0u),

	m_dayDuration(sf::seconds(5.f)),
	...
	m_rockSize(sf::Vector2f(15.f, 50.f), sf::Vector2f(40.f, 70.f)),
	m_rockPartCount(2.f, 10.f),
	m_rockColor(0, 31, 63),

	m_treeDepth(5u, 5u),
	m_treeSize(sf::Vector2f(10.f, 20.f), sf::Vector2f(20.f, 50.f)),
