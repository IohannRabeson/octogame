#include "GroundGrass.hpp"
#include "ABiome.hpp"
#include "Tile.hpp"
#include "Progress.hpp"
#include <Camera.hpp>

GroundGrass::GroundGrass(bool onInstance) :
	m_type(0u),
	m_deep(0.f),
...
void GroundGrass::createGroundGrass(std::size_t type, sf::Vector2f const & origin, sf::Color const & color, octo::VertexBuilder& builder)
{
...
void GroundGrass::setup(ABiome& biome)
{
...
void GroundGrass::update(sf::Time, octo::VertexBuilder& builder, ABiome& biome)
{
	sf::Vector2f position = getPosition();
	position.y -= Tile::TileSize;
	//TODO:: Add to biome
	if (biome.getId() != Level::IceC)
		createGroundGrass(m_type, position + sf::Vector2f(0.f, m_deep), m_color, builder);
}
