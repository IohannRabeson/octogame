	...
	m_soundVolume(0.6f)
{
	...
	m_sound = audio.playSound(resources.getSound(OBJECT_PORTAL_START_OGG), 0.f, m_generator.randomFloat(0.9f, 1.1f), sf::Vector3f(m_box->getBaryCenter().x, m_box->getBaryCenter().y, -150.f) , 500.f, 50.f);
